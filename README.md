...
# The guide for TgDLF:
## Content
grid_configuration.py: Experimental parameter setting and model hyperparameter setting
grid_data_v2.py: Generate experimental datasets. The generated datasets include variables such as load/load ratio and weather forecast data. The 'ave_ratio' function generates the default value of the dimensionless trend. When more accurate expert experience is available, this function can be replaced by the dimensionless trend generated by the expert system.
